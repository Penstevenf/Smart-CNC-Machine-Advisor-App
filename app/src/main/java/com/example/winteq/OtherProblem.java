...
public class OtherProblem extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Find Variable
        drawerLayout = findViewById(R.id.otherproblem); //change xml id
        ...
        title = findViewById(R.id.partreq);
    ...
    public void onBackPressed() {
        if (drawerLayout.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent intent = new Intent(OtherProblem.this, TechnicalSupport.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.nav_home:
                Intent intent1 = new Intent(OtherProblem.this, Dashboard.class);
                startActivity(intent1);
                break;

            case R.id.nav_profile:
                Intent intent2 = new Intent(OtherProblem.this, Profile.class);
            ...
            case R.id.nav_logout:
                ...
                editor.clear();
                editor.commit();
                Toast.makeText(OtherProblem.this, "Log out successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(OtherProblem.this, Login.class);
                startActivity(intent);
                break;

            case R.id.nav_grafik:
                Intent intent3 = new Intent(OtherProblem.this, Graph.class);
                startActivity(intent3);
                break;

            case R.id.nav_contact:
                Intent intent4 = new Intent(OtherProblem.this, Contact.class);
                startActivity(intent4);
                break;

            case R.id.nav_help:
                Intent intent5 = new Intent(OtherProblem.this, Help.class);
...
//      Toast.makeText(this, encodedImage, Toast.LENGTH_SHORT).show();
    ...
    private void otherProblem() {
        ...
        String pa = title.getText().toString();
        String image = getStringImage(bitmap);
        ProgressDialog pd = new ProgressDialog(OtherProblem.this);
        pd.setMessage("Loading...");
        pd.setCancelable(false);
        pd.show();

        Call<HistoryData> hisaddcall = apiInterface.aiProblemData(ln, st, mc, pc, pb, pa, image);
        hisaddcall.enqueue(new Callback<HistoryData>() {
            ...
            public void onResponse(Call<HistoryData> call, Response<HistoryData> response) {
                ...
                if(response.body() != null && response.body().isStatus()){
                    ...
                    Toast.makeText(OtherProblem.this, sr, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(OtherProblem.this, TechnicalSupport.class);
                    startActivity(intent);
                    finish();
                } else {
            ...
            public void onFailure(Call<HistoryData> call, Throwable t) {
                pd.dismiss();
                Toast.makeText(OtherProblem.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}