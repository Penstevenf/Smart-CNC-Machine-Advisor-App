...
public class SolutionAdd extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState); //Remove top
        ...
        //Find Variable
        drawerLayout = findViewById(R.id.soladd); //change xml id
        ...
        idtv22 = findViewById(R.id.idtv22);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.nav_home:
                Intent intent1 = new Intent(SolutionAdd.this, Dashboard.class);
                startActivity(intent1);
                break;

            case R.id.nav_profile:
                Intent intent2 = new Intent(SolutionAdd.this, Profile.class);
            ...
            case R.id.nav_logout:
                ...
                editor.clear();
                editor.commit();
                Toast.makeText(SolutionAdd.this, "Log out successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(SolutionAdd.this, Login.class);
                startActivity(intent);
                break;

            case R.id.nav_grafik:
                Intent intent3 = new Intent(SolutionAdd.this, Graph.class);
                startActivity(intent3);
                break;

            case R.id.nav_contact:
                Intent intent4 = new Intent(SolutionAdd.this, Contact.class);
                startActivity(intent4);
                break;

            case R.id.nav_help:
                Intent intent5 = new Intent(SolutionAdd.this, Help.class);
...
//      Toast.makeText(this, encodedImage, Toast.LENGTH_SHORT).show();
    ...
    private void solutionAdd() {
        String id_hist = idtv22.getText().toString();
        String solution = desc.getText().toString();
        String title = part.getText().toString();
        String image_solution = getStringImage(bitmap);
        ProgressDialog pd = new ProgressDialog(SolutionAdd.this);
        pd.setMessage("Loading...");
        pd.setCancelable(false);
        pd.show();

        Call<HistoryData> hisaddcall = apiInterface.aiSolutionData(id_hist, solution, title, image_solution);
        hisaddcall.enqueue(new Callback<HistoryData>() {
            ...
            public void onResponse(Call<HistoryData> call, Response<HistoryData> response) {
                ...
                if(response.body() != null && response.body().isStatus()){
                    ...
                    Toast.makeText(SolutionAdd.this, sr, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(SolutionAdd.this, TechnicalSupport.class);
                    startActivity(intent);
                    finish();
                } else {
                    pd.dismiss();
            ...
            public void onFailure(Call<HistoryData> call, Throwable t) {
                pd.dismiss();
                Toast.makeText(SolutionAdd.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}