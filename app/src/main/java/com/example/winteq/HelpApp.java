...
public class HelpApp extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.happ);
    ...
    public void onBackPressed() {
        if (drawerLayout.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent intent = new Intent(HelpApp.this,Help.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.nav_home:
                Intent intent1 = new Intent(HelpApp.this, Dashboard.class);
            ...
            case R.id.nav_logout:
                ...
                editor.clear();
                editor.commit();
                Toast.makeText(HelpApp.this, "Log out successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(HelpApp.this, Login.class);
                startActivity(intent);
                break;
            ...
            case R.id.nav_contact:
                Intent intent3 = new Intent(HelpApp.this, Contact.class);
                startActivity(intent3);
                break;

            case R.id.nav_help:
                Intent intent4 = new Intent(HelpApp.this, Help.class);
