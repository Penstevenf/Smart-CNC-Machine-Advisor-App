...
public class Graph extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.graph);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.nav_home:
                Intent intent1 = new Intent(Graph.this, Dashboard.class);
            ...
            case R.id.nav_logout:
                ...
                editor.clear();
                editor.commit();
                Toast.makeText(Graph.this, "Log out successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Graph.this, Login.class);
                startActivity(intent);
                break;
            ...
            case R.id.nav_contact:
                Intent intent3 = new Intent(Graph.this, Contact.class);
                startActivity(intent3);
                break;

            case R.id.nav_help:
                Intent intent4 = new Intent(Graph.this, Help.class);
